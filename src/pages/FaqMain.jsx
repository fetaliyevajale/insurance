  ...
  const faqData = [
    {
      ...
      answer: "Insurance is a contract between an insurance company and an individual or business. The insurance company agrees to pay for losses that the individual or business may suffer, in exchange for a premium paid by the individual or business."
    },
    {
    ...
    <div className="faqMain">
      {faqData.map((faq, index) => (
        <div className="faqMainText" key={index}>
          <div className="faqMainTextChild" onClick={() => handleToggle(index)}>
            <h1>{faq.question}</h1>
